...
#func global ClearDrawScreen "dx_ClearDrawScreen" sptr
...
#func global SetKeyInputNumberToint "dx_SetKeyInputNumberToint" int,int
#func global GetKeyInputString "dx_GetKeyInputString" str,int
#func global GetKeyInputNumber "dx_GetKeyInputNumber" int
#func global GetKeyInputNumberToint "dx_GetKeyInputNumberToint" int
...
#func global SetShadowMapLightDirection "dx_SetShadowMapLightDirection" int,int,int,int
...
#func global SetShadowMapDrawArea "dx_SetShadowMapDrawArea" int,int,int,int,int,int,int
#func global ResetShadowMapDrawArea "dx_ResetShadowMapDrawArea" int
#func global SetShadowMapAdjustDepth "dx_SetShadowMapAdjustDepth" int,int
...
#func global SetDrawValidintTypeGraphCreateFlag "dx_SetDrawValidintTypeGraphCreateFlag" int
#func global GetDrawValidintTypeGraphCreateFlag "dx_GetDrawValidintTypeGraphCreateFlag" 
...
#func global DrawGraphF "dx_DrawGraphF" int,int,int,int
#func global DrawExtendGraphF "dx_DrawExtendGraphF" int,int,int,int,int,int
#func global DrawRotaGraphF "dx_DrawRotaGraphF" int,int,double,double,int,int,int
#func global DrawRotaGraph2F "dx_DrawRotaGraph2F" int,int,int,int,double,double,int,int,int
#func global DrawRotaGraph3F "dx_DrawRotaGraph3F" int,int,int,int,double,double,double,int,int,int
#func global DrawModiGraphF "dx_DrawModiGraphF" int,int,int,int,int,int,int,int,int,int
#func global DrawTurnGraphF "dx_DrawTurnGraphF" int,int,int,int
...
#func global DrawRectGraphF "dx_DrawRectGraphF" int,int,int,int,int,int,int,int,int
#func global DrawRectExtendGraphF "dx_DrawRectExtendGraphF" int,int,int,int,int,int,int,int,int,int
#func global DrawRectRotaGraphF "dx_DrawRectRotaGraphF" int,int,int,int,int,int,double,double,int,int,int
#func global DrawRectRotaGraph2F "dx_DrawRectRotaGraph2F" int,int,int,int,int,int,int,int,double,double,int,int,int
#func global DrawRectRotaGraph3F "dx_DrawRectRotaGraph3F" int,int,int,int,int,int,int,int,double,double,double,int,int,int
#func global DrawRectModiGraphF "dx_DrawRectModiGraphF" int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global DrawGraph3D "dx_DrawGraph3D" int,int,int,int,int
#func global DrawExtendGraph3D "dx_DrawExtendGraph3D" int,int,int,double,double,int,int
#func global DrawRotaGraph3D "dx_DrawRotaGraph3D" int,int,int,double,double,int,int,int
#func global DrawRota2Graph3D "dx_DrawRota2Graph3D" int,int,int,int,int,double,double,double,int,int,int
#func global DrawModiBillboard3D "dx_DrawModiBillboard3D" int,int,int,int,int,int,int,int,int,int,int,int,int
#func global DrawBillboard3D "dx_DrawBillboard3D" int,int,int,int,int,int,int,int,int,int
...
#func global SetDrawZ "dx_SetDrawZ" int
...
#func global SetDraw3DScale "dx_SetDraw3DScale" int
...
#func global GetBillboardPixelSize "dx_GetBillboardPixelSize" int,int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvWorldPosToViewPos "dx_ConvWorldPosToViewPos" var,int,int,int
// 戻り値が構造体です（VECTOR_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvWorldPosToViewPosD "dx_ConvWorldPosToViewPosD" var,double,double,double
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvWorldPosToScreenPos "dx_ConvWorldPosToScreenPos" var,int,int,int
// 戻り値が構造体です（VECTOR_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvWorldPosToScreenPosD "dx_ConvWorldPosToScreenPosD" var,double,double,double
// 戻り値が構造体です（int4）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvWorldPosToScreenPosPlusW "dx_ConvWorldPosToScreenPosPlusW" var,int,int,int
// 戻り値が構造体です（DOUBLE4）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvWorldPosToScreenPosPlusWD "dx_ConvWorldPosToScreenPosPlusWD" var,double,double,double
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvScreenPosToWorldPos "dx_ConvScreenPosToWorldPos" var,int,int,int
// 戻り値が構造体です（VECTOR_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvScreenPosToWorldPosD "dx_ConvScreenPosToWorldPosD" var,double,double,double
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global ConvScreenPosToWorldPos_ZLinear "dx_ConvScreenPosToWorldPos_ZLinear" var,int,int,int
// 戻り値が構造体です（VECTOR_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#func global SetTextureAddressTransform "dx_SetTextureAddressTransform" int,int,int,int,int,int,int
#func global SetTextureAddressTransformMatrix "dx_SetTextureAddressTransformMatrix" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global SetFogStartEnd "dx_SetFogStartEnd" int,int
#func global GetFogStartEnd "dx_GetFogStartEnd" sptr,sptr
#func global SetFogDensity "dx_SetFogDensity" int
...
#func global GetDrawintCoordType "dx_GetDrawintCoordType" 
...
#func global SetVSConstSF "dx_SetVSConstSF" int,int
#func global SetVSConstF "dx_SetVSConstF" int,int,int,int,int
#func global SetVSConstFMtx "dx_SetVSConstFMtx" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
#func global SetVSConstFMtxT "dx_SetVSConstFMtxT" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global SetPSConstSF "dx_SetPSConstSF" int,int
#func global SetPSConstF "dx_SetPSConstF" int,int,int,int,int
#func global SetPSConstFMtx "dx_SetPSConstFMtx" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
#func global SetPSConstFMtxT "dx_SetPSConstFMtxT" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global SetCameraNearFar "dx_SetCameraNearFar" int,int
#func global SetCameraNearFarD "dx_SetCameraNearFarD" double,double
#func global SetCameraPositionAndTarget_UpVecY "dx_SetCameraPositionAndTarget_UpVecY" int,int,int,int,int,int
...
#func global SetCameraPositionAndTargetAndUpVec "dx_SetCameraPositionAndTargetAndUpVec" int,int,int,int,int,int,int,int,int
...
#func global SetCameraPositionAndAngle "dx_SetCameraPositionAndAngle" int,int,int,int,int,int
#func global SetCameraPositionAndAngleD "dx_SetCameraPositionAndAngleD" double,double,double,double,double,double
#func global SetCameraViewMatrix "dx_SetCameraViewMatrix" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global SetCameraScreenCenter "dx_SetCameraScreenCenter" int,int
#func global SetCameraScreenCenterD "dx_SetCameraScreenCenterD" double,double
#func global SetupCamera_Perspective "dx_SetupCamera_Perspective" int
#func global SetupCamera_PerspectiveD "dx_SetupCamera_PerspectiveD" double
#func global SetupCamera_Ortho "dx_SetupCamera_Ortho" int
#func global SetupCamera_OrthoD "dx_SetupCamera_OrthoD" double
#func global SetupCamera_ProjectionMatrix "dx_SetupCamera_ProjectionMatrix" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global SetCameraDotAspect "dx_SetCameraDotAspect" int
#func global SetCameraDotAspectD "dx_SetCameraDotAspectD" double
#func global CheckCameraViewClip "dx_CheckCameraViewClip" int,int,int
#func global CheckCameraViewClipD "dx_CheckCameraViewClipD" double,double,double
#func global CheckCameraViewClip_Dir "dx_CheckCameraViewClip_Dir" int,int,int
#func global CheckCameraViewClip_DirD "dx_CheckCameraViewClip_DirD" double,double,double
#func global CheckCameraViewClip_Box "dx_CheckCameraViewClip_Box" int,int,int,int,int,int
...
#func global SetMaterialParam "dx_SetMaterialParam" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
#func global SetUseSpecular "dx_SetUseSpecular" int
#func global SetGlobalAmbientLight "dx_SetGlobalAmbientLight" int,int,int,int
#func global ChangeLightTypeDir "dx_ChangeLightTypeDir" int,int,int
#func global ChangeLightTypeSpot "dx_ChangeLightTypeSpot" int,int,int,int,int,int,int,int,int,int,int,int
#func global ChangeLightTypePoint "dx_ChangeLightTypePoint" int,int,int,int,int,int,int
...
#func global SetLightDifColor "dx_SetLightDifColor" int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global GetLightDifColor "dx_GetLightDifColor" var,
#func global SetLightSpcColor "dx_SetLightSpcColor" int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global GetLightSpcColor "dx_GetLightSpcColor" var,
#func global SetLightAmbColor "dx_SetLightAmbColor" int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global GetLightAmbColor "dx_GetLightAmbColor" var,
#func global SetLightDirection "dx_SetLightDirection" int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global GetLightDirection "dx_GetLightDirection" var,
#func global SetLightPosition "dx_SetLightPosition" int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global GetLightPosition "dx_GetLightPosition" var,
#func global SetLightRangeAtten "dx_SetLightRangeAtten" int,int,int,int
#func global GetLightRangeAtten "dx_GetLightRangeAtten" sptr,sptr,sptr,sptr
#func global SetLightAngle "dx_SetLightAngle" int,int
#func global GetLightAngle "dx_GetLightAngle" sptr,sptr
#func global SetLightUseShadowMap "dx_SetLightUseShadowMap" int,int
#func global CreateDirLightHandle "dx_CreateDirLightHandle" int,int,int
#func global CreateSpotLightHandle "dx_CreateSpotLightHandle" int,int,int,int,int,int,int,int,int,int,int,int
#func global CreatePointLightHandle "dx_CreatePointLightHandle" int,int,int,int,int,int,int
...
#func global SetLightDifColorHandle "dx_SetLightDifColorHandle" int,int,int,int,int
#func global SetLightSpcColorHandle "dx_SetLightSpcColorHandle" int,int,int,int,int
#func global SetLightAmbColorHandle "dx_SetLightAmbColorHandle" int,int,int,int,int
#func global SetLightDirectionHandle "dx_SetLightDirectionHandle" int,int,int,int
#func global SetLightPositionHandle "dx_SetLightPositionHandle" int,int,int,int
#func global SetLightRangeAttenHandle "dx_SetLightRangeAttenHandle" int,int,int,int,int
#func global SetLightAngleHandle "dx_SetLightAngleHandle" int,int,int
...
#func global DrawStringF "dx_DrawStringF" int,int,str,int,int
#func global DrawVStringF "dx_DrawVStringF" int,int,str,int,int
#func global DrawExtendStringF "dx_DrawExtendStringF" int,int,double,double,str,int,int
#func global DrawExtendVStringF "dx_DrawExtendVStringF" int,int,double,double,str,int,int
#func global DrawRotaStringF "dx_DrawRotaStringF" int,int,double,double,double,double,double,int,int,int,str
...
#func global DrawStringFToHandle "dx_DrawStringFToHandle" int,int,str,int,int,int,int
#func global DrawVStringFToHandle "dx_DrawVStringFToHandle" int,int,str,int,int,int
#func global DrawExtendStringFToHandle "dx_DrawExtendStringFToHandle" int,int,double,double,str,int,int,int,int
#func global DrawExtendVStringFToHandle "dx_DrawExtendVStringFToHandle" int,int,double,double,str,int,int,int
#func global DrawRotaStringFToHandle "dx_DrawRotaStringFToHandle" int,int,double,double,double,double,double,int,int,int,int,str
...
#func global CreateViewportMatrix "dx_CreateViewportMatrix" sptr,int,int,int,int
#func global CreateViewportMatrixD "dx_CreateViewportMatrixD" sptr,double,double,double,double
#func global CreateRotationXYZMatrix "dx_CreateRotationXYZMatrix" sptr,int,int,int
#func global CreateRotationXYZMatrixD "dx_CreateRotationXYZMatrixD" sptr,double,double,double
#func global CreateRotationXZYMatrix "dx_CreateRotationXZYMatrix" sptr,int,int,int
#func global CreateRotationXZYMatrixD "dx_CreateRotationXZYMatrixD" sptr,double,double,double
#func global CreateRotationYXZMatrix "dx_CreateRotationYXZMatrix" sptr,int,int,int
#func global CreateRotationYXZMatrixD "dx_CreateRotationYXZMatrixD" sptr,double,double,double
#func global CreateRotationYZXMatrix "dx_CreateRotationYZXMatrix" sptr,int,int,int
#func global CreateRotationYZXMatrixD "dx_CreateRotationYZXMatrixD" sptr,double,double,double
#func global CreateRotationZXYMatrix "dx_CreateRotationZXYMatrix" sptr,int,int,int
#func global CreateRotationZXYMatrixD "dx_CreateRotationZXYMatrixD" sptr,double,double,double
#func global CreateRotationZYXMatrix "dx_CreateRotationZYXMatrix" sptr,int,int,int
...
#func global VectorScale "dx_VectorScale" sptr,sptr,int
...
#func global TriangleBarycenter "dx_TriangleBarycenter" int,int,int,int,int,int,int,int,int,int,int,int,sptr,sptr,sptr
...
#func global Segment_Segment_MinLength "dx_Segment_Segment_MinLength" int,int,int,int,int,int,int,int,int,int,int,int
#func global Segment_Segment_MinLength_Square "dx_Segment_Segment_MinLength_Square" int,int,int,int,int,int,int,int,int,int,int,int
#func global Segment_Triangle_MinLength "dx_Segment_Triangle_MinLength" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
#func global Segment_Triangle_MinLength_Square "dx_Segment_Triangle_MinLength_Square" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
#func global Segment_Point_MinLength "dx_Segment_Point_MinLength" int,int,int,int,int,int,int,int,int
#func global Segment_Point_MinLength_Square "dx_Segment_Point_MinLength_Square" int,int,int,int,int,int,int,int,int
#func global Triangle_Point_MinLength "dx_Triangle_Point_MinLength" int,int,int,int,int,int,int,int,int,int,int,int
#func global Triangle_Point_MinLength_Square "dx_Triangle_Point_MinLength_Square" int,int,int,int,int,int,int,int,int,int,int,int
#func global Triangle_Triangle_MinLength "dx_Triangle_Triangle_MinLength" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
#func global Triangle_Triangle_MinLength_Square "dx_Triangle_Triangle_MinLength_Square" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global Plane_Point_MinLength_Position "dx_Plane_Point_MinLength_Position" var,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（VECTOR_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#func global Plane_Point_MinLength "dx_Plane_Point_MinLength" int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（HITRESULT_LINE）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global HitCheck_Line_Triangle "dx_HitCheck_Line_Triangle" var,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
#func global HitCheck_Triangle_Triangle "dx_HitCheck_Triangle_Triangle" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
// 戻り値が構造体です（HITRESULT_LINE）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global HitCheck_Line_Cube "dx_HitCheck_Line_Cube" var,int,int,int,int,int,int,int,int,int,int,int,int
#func global HitCheck_Line_Sphere "dx_HitCheck_Line_Sphere" int,int,int,int,int,int,int,int,int,int
...
#func global HitCheck_Sphere_Sphere "dx_HitCheck_Sphere_Sphere" int,int,int,int,int,int,int,int
#func global HitCheck_Sphere_SphereD "dx_HitCheck_Sphere_SphereD" double,double,double,double,double,double,double,double
#func global HitCheck_Sphere_Capsule "dx_HitCheck_Sphere_Capsule" int,int,int,int,int,int,int,int,int,int,int
...
#func global HitCheck_Sphere_Triangle "dx_HitCheck_Sphere_Triangle" int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global HitCheck_Capsule_Capsule "dx_HitCheck_Capsule_Capsule" int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global HitCheck_Capsule_Triangle "dx_HitCheck_Capsule_Triangle" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MMult "dx_MMult" var,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MScale "dx_MScale" var,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MAdd "dx_MAdd" var,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetScale "dx_MGetScale" var,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetScaleD "dx_MGetScaleD" var,double,double,double
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotX "dx_MGetRotX" var,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotXD "dx_MGetRotXD" var,double
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotY "dx_MGetRotY" var,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotYD "dx_MGetRotYD" var,double
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotZ "dx_MGetRotZ" var,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotZD "dx_MGetRotZD" var,double
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotAxis "dx_MGetRotAxis" var,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotAxisD "dx_MGetRotAxisD" var,double,double,double,double
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotVec2 "dx_MGetRotVec2" var,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetRotVec2D "dx_MGetRotVec2D" var,double,double,double,double,double,double
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetTranslate "dx_MGetTranslate" var,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetTranslateD "dx_MGetTranslateD" var,double,double,double
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetAxis1 "dx_MGetAxis1" var,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetAxis2 "dx_MGetAxis2" var,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MTranspose "dx_MTranspose" var,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MInverse "dx_MInverse" var,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MGetSize "dx_MGetSize" var,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（VECTOR_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global VNorm "dx_VNorm" var,int,int,int
// 戻り値が構造体です（VECTOR_D）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global VNormD "dx_VNormD" var,double,double,double
#func global VSize "dx_VSize" int,int,int
#func global VCos "dx_VCos" int,int,int,int,int,int
#func global VRad "dx_VRad" int,int,int,int,int,int
...
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global GetColorF "dx_GetColorF" var,int,int,int,int
// 戻り値が構造体です（COLOR_U8）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#func global DrawPixelSoftImageF "dx_DrawPixelSoftImageF" int,int,int,int,int,int,int
...
#func global Set3DPositionSoundMem "dx_Set3DPositionSoundMem" int,int,int,int
#func global Set3DRadiusSoundMem "dx_Set3DRadiusSoundMem" int,int
#func global Set3DVelocitySoundMem "dx_Set3DVelocitySoundMem" int,int,int,int
#func global SetNextPlay3DPositionSoundMem "dx_SetNextPlay3DPositionSoundMem" int,int,int,int
#func global SetNextPlay3DRadiusSoundMem "dx_SetNextPlay3DRadiusSoundMem" int,int
#func global SetNextPlay3DVelocitySoundMem "dx_SetNextPlay3DVelocitySoundMem" int,int,int,int
...
#func global Set3DSoundOneMetre "dx_Set3DSoundOneMetre" int
#func global Set3DSoundListenerPosAndFrontPos_UpVecY "dx_Set3DSoundListenerPosAndFrontPos_UpVecY" int,int,int,int,int,int
#func global Set3DSoundListenerPosAndFrontPosAndUpVec "dx_Set3DSoundListenerPosAndFrontPosAndUpVec" int,int,int,int,int,int,int,int,int
#func global Set3DSoundListenerVelocity "dx_Set3DSoundListenerVelocity" int,int,int
#func global Set3DSoundListenerConeAngle "dx_Set3DSoundListenerConeAngle" int,int
#func global Set3DSoundListenerConeVolume "dx_Set3DSoundListenerConeVolume" int,int
...
#func global MV1SetLoadModelReMakeNormalSmoothingAngle "dx_MV1SetLoadModelReMakeNormalSmoothingAngle" int
...
#func global MV1SetLoadModelPhysicsWorldGravity "dx_MV1SetLoadModelPhysicsWorldGravity" int
#func global MV1SetLoadCalcPhysicsWorldGravity "dx_MV1SetLoadCalcPhysicsWorldGravity" int,int,int,int
...
#func global MV1DrawModelDebug "dx_MV1DrawModelDebug" int,int,int,int,int,int
...
#func global MV1SetPosition "dx_MV1SetPosition" int,int,int,int
...
#func global MV1SetScale "dx_MV1SetScale" int,int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetScale "dx_MV1GetScale" var,int
#func global MV1SetRotationXYZ "dx_MV1SetRotationXYZ" int,int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetRotationXYZ "dx_MV1GetRotationXYZ" var,int
#func global MV1SetRotationZYAxis "dx_MV1SetRotationZYAxis" int,int,int,int,int,int,int,int
#func global MV1SetRotationMatrix "dx_MV1SetRotationMatrix" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetRotationMatrix "dx_MV1GetRotationMatrix" var,int
#func global MV1SetMatrix "dx_MV1SetMatrix" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global MV1SetDifColorScale "dx_MV1SetDifColorScale" int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetDifColorScale "dx_MV1GetDifColorScale" var,int
#func global MV1SetSpcColorScale "dx_MV1SetSpcColorScale" int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetSpcColorScale "dx_MV1GetSpcColorScale" var,int
#func global MV1SetEmiColorScale "dx_MV1SetEmiColorScale" int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetEmiColorScale "dx_MV1GetEmiColorScale" var,int
#func global MV1SetAmbColorScale "dx_MV1SetAmbColorScale" int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#func global MV1SetOpacityRate "dx_MV1SetOpacityRate" int,int
...
#func global MV1SetPhysicsWorldGravity "dx_MV1SetPhysicsWorldGravity" int,int,int,int
#func global MV1PhysicsCalculation "dx_MV1PhysicsCalculation" int,int
...
#func global MV1SetAttachAnimTime "dx_MV1SetAttachAnimTime" int,int,int
...
#func global MV1SetAttachAnimBlendRate "dx_MV1SetAttachAnimBlendRate" int,int,int
#func global MV1GetAttachAnimBlendRate "dx_MV1GetAttachAnimBlendRate" int,int
#func global MV1SetAttachAnimBlendRateToFrame "dx_MV1SetAttachAnimBlendRateToFrame" int,int,int,int,int
...
#func global MV1GetAnimKeyDataIndexFromTime "dx_MV1GetAnimKeyDataIndexFromTime" int,int,int
// 戻り値が構造体です（int4）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetAnimKeyDataToQuaternion "dx_MV1GetAnimKeyDataToQuaternion" var,int,int,int
// 戻り値が構造体です（int4）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetAnimKeyDataToQuaternionFromTime "dx_MV1GetAnimKeyDataToQuaternionFromTime" var,int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetAnimKeyDataToVector "dx_MV1GetAnimKeyDataToVector" var,int,int,int
// 戻り値が構造体です（VECTOR）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetAnimKeyDataToVectorFromTime "dx_MV1GetAnimKeyDataToVectorFromTime" var,int,int,int
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetAnimKeyDataToMatrix "dx_MV1GetAnimKeyDataToMatrix" var,int,int,int
// 戻り値が構造体です（MATRIX）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetAnimKeyDataToMatrixFromTime "dx_MV1GetAnimKeyDataToMatrixFromTime" var,int,int,int
#func global MV1GetAnimKeyDataToFlat "dx_MV1GetAnimKeyDataToFlat" int,int,int
#func global MV1GetAnimKeyDataToFlatFromTime "dx_MV1GetAnimKeyDataToFlatFromTime" int,int,int
#func global MV1GetAnimKeyDataToLinear "dx_MV1GetAnimKeyDataToLinear" int,int,int
#func global MV1GetAnimKeyDataToLinearFromTime "dx_MV1GetAnimKeyDataToLinearFromTime" int,int,int
...
#func global MV1SetMaterialDifColor "dx_MV1SetMaterialDifColor" int,int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetMaterialDifColor "dx_MV1GetMaterialDifColor" var,int,int
#func global MV1SetMaterialSpcColor "dx_MV1SetMaterialSpcColor" int,int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetMaterialSpcColor "dx_MV1GetMaterialSpcColor" var,int,int
#func global MV1SetMaterialEmiColor "dx_MV1SetMaterialEmiColor" int,int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetMaterialEmiColor "dx_MV1GetMaterialEmiColor" var,int,int
#func global MV1SetMaterialAmbColor "dx_MV1SetMaterialAmbColor" int,int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1GetMaterialAmbColor "dx_MV1GetMaterialAmbColor" var,int,int
#func global MV1SetMaterialSpcPower "dx_MV1SetMaterialSpcPower" int,int,int
...
#func global MV1SetMaterialOutLineWidthAll "dx_MV1SetMaterialOutLineWidthAll" int,int
#func global MV1SetMaterialOutLineWidth "dx_MV1SetMaterialOutLineWidth" int,int,int
#func global MV1GetMaterialOutLineWidth "dx_MV1GetMaterialOutLineWidth" int,int
#func global MV1SetMaterialOutLineDotWidthAll "dx_MV1SetMaterialOutLineDotWidthAll" int,int
#func global MV1SetMaterialOutLineDotWidth "dx_MV1SetMaterialOutLineDotWidth" int,int,int
#func global MV1GetMaterialOutLineDotWidth "dx_MV1GetMaterialOutLineDotWidth" int,int
#func global MV1SetMaterialOutLineColorAll "dx_MV1SetMaterialOutLineColorAll" int,int,int,int,int
#func global MV1SetMaterialOutLineColor "dx_MV1SetMaterialOutLineColor" int,int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#func global MV1SetTextureBumpImageNextPixelLength "dx_MV1SetTextureBumpImageNextPixelLength" int,int,int
...
#func global MV1SetFrameUserLocalMatrix "dx_MV1SetFrameUserLocalMatrix" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global MV1SetFrameDifColorScale "dx_MV1SetFrameDifColorScale" int,int,int,int,int,int
#func global MV1SetFrameSpcColorScale "dx_MV1SetFrameSpcColorScale" int,int,int,int,int,int
#func global MV1SetFrameEmiColorScale "dx_MV1SetFrameEmiColorScale" int,int,int,int,int,int
#func global MV1SetFrameAmbColorScale "dx_MV1SetFrameAmbColorScale" int,int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#func global MV1SetFrameOpacityRate "dx_MV1SetFrameOpacityRate" int,int,int
...
#func global MV1SetFrameTextureAddressTransform "dx_MV1SetFrameTextureAddressTransform" int,int,int,int,int,int,int,int,int
#func global MV1SetFrameTextureAddressTransformMatrix "dx_MV1SetFrameTextureAddressTransformMatrix" int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int
...
#func global MV1SetMeshDifColorScale "dx_MV1SetMeshDifColorScale" int,int,int,int,int,int
#func global MV1SetMeshSpcColorScale "dx_MV1SetMeshSpcColorScale" int,int,int,int,int,int
#func global MV1SetMeshEmiColorScale "dx_MV1SetMeshEmiColorScale" int,int,int,int,int,int
#func global MV1SetMeshAmbColorScale "dx_MV1SetMeshAmbColorScale" int,int,int,int,int,int
// 戻り値が構造体です（COLOR_F）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#func global MV1SetMeshOpacityRate "dx_MV1SetMeshOpacityRate" int,int,int
...
#func global MV1SetShapeRate "dx_MV1SetShapeRate" int,int,int
...
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1CollCheck_Line "dx_MV1CollCheck_Line" var,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MV1_COLL_RESULT_POLY_DIM）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1CollCheck_LineDim "dx_MV1CollCheck_LineDim" var,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MV1_COLL_RESULT_POLY_DIM）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1CollCheck_Sphere "dx_MV1CollCheck_Sphere" var,int,int,int,int,int,int
// 戻り値が構造体です（MV1_COLL_RESULT_POLY_DIM）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1CollCheck_Capsule "dx_MV1CollCheck_Capsule" var,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MV1_COLL_RESULT_POLY_DIM）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
#func global MV1CollCheck_Triangle "dx_MV1CollCheck_Triangle" var,int,int,int,int,int,int,int,int,int,int,int
// 戻り値が構造体です（MV1_COLL_RESULT_POLY）
// 第一引数に戻り値を返却します。パラメタは第二引数以降にずれます。
...
#define global DX_DRAWintCOORDTYPE_DIRECT3D9 0
#define global DX_DRAWintCOORDTYPE_DIRECT3D10 1
